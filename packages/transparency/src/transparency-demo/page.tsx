...
const TransparencyDemoPage = () => {
  const scenarios = [
    ...
    },
    {
      ...
      description:
        "Content that builds upon existing material with significant modifications",
    },
    {
      id: "3",
    ...
    },
    {
      ...
      description:
        "Content similar to a source where the original creator is private",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {scenarios.map((scenario) => {
              ...
              return (
                <Card
                  key={scenario.id}
                  className="bg-black/20 border-ghost-purple/20 backdrop-blur-lg"
                >
                  <CardHeader>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      <h4 className="text-sm font-medium text-ghost-purple mb-2">
                        Compact Badge:
                      </h4>
                      {data.is_clone ? (
                      ...
                      {data.is_clone ? (
                        <div className="p-3 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                          ...
                          <p className="text-gray-300 text-sm">
                            {data.buyer_message.description}
                          </p>
          ...
          <div className="mt-12 p-6 rounded-xl bg-ghost-dark/30 border border-ghost-purple/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
              <div>
                <h3 className="font-medium text-ghost-neon mb-2">
                  1. Analysis
                </h3>
                <p className="text-gray-400">
                  Our system analyzes content similarity using advanced
                  algorithms to detect potential clones.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-ghost-neon mb-2">
                ...
                <p className="text-gray-400">
                  Content is classified as Original, Modified, Heavily Inspired,
                  or Clone based on similarity scores.
                </p>
              </div>
              <div>
                <h3 className="font-medium text-ghost-neon mb-2">
                ...
                <p className="text-gray-400">
                  Buyers see clear information about content originality before
