 ...
 */
export async function checkContentAccess(contentId, userId, options = {}) {
    const { requireAuth = true, allowOwner = true, allowPurchaser = true } = options;
 ...
 */
export async function enforceContentAccess(contentId, userId, options = {}) {
