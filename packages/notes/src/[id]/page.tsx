...
const NoteDetailPage = ({ params }: NoteDetailPageProps) => {
      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-br from-ghost-black via-ghost-dark to-ghost-black">
        ...
        <div className="flex-grow flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-ghost-purple mb-4">
              Note Not Found
            </h2>
  ...
  const whyBuyText =
    "Unlock exclusive insights and advanced techniques with this note. It's a comprehensive guide filled with rare information, practical examples, and expert analysis that you won't find anywhere else. Perfect for accelerating your skills.";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="prose prose-invert max-w-none prose-p:text-gray-300 prose-headings:text-white prose-strong:text-ghost-neon">
                ...
                {!isPurchased && (
                  <div className="mt-8 p-6 rounded-lg bg-ghost-dark/30 border border-ghost-purple/20 shadow-lg">
                    <h2 className="text-2xl font-bold text-white mb-3 flex items-center">
                      <SparklesIcon className="h-6 w-6 mr-3 text-ghost-neon" />
                      Why Buy This Note?
                    </h2>
                ...
                {isPurchased && (
                  <div className="mt-8">
                    <h2 className="text-2xl font-bold text-white mb-4 border-b border-ghost-purple/20 pb-2">
                      Full Note Content
                    </h2>
                    <p>
                ...
                <div className="rounded-xl border border-ghost-purple/20 bg-black/20 backdrop-blur-lg shadow-2xl shadow-ghost-purple/5">
                  ...
                  <div className="relative aspect-video rounded-t-xl overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <LockIcon className="h-12 w-12 text-white/50" />
                    </div>
                  ...
                  <div className="p-6">
                    {isPurchased ? (
                      <div className="text-center py-4 space-y-4">
                        <h3 className="text-xl font-bold text-ghost-neon mb-2">
                          Purchased!
                        </h3>
                    ...
                    <div className="mt-4 border-t border-ghost-purple/20 pt-4 flex justify-around items-center">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="text-gray-400 hover:text-ghost-neon hover:bg-ghost-purple/10 rounded-full"
                      >
                      ...
                      <Button
                        variant="ghost"
                        size="icon"
                        className="text-gray-400 hover:text-red-500 hover:bg-ghost-purple/10 rounded-full"
                      >
