...
const AuthModal = ({ isOpen, onClose, initialMode }: AuthModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-gradient-to-br from-ghost-dark via-ghost-gray to-ghost-dark border border-ghost-purple/30 rounded-2xl shadow-2xl shadow-ghost-purple/20 animate-in zoom-in-95 slide-in-from-bottom-5 duration-300">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="px-8 pb-4">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-ghost-dark px-2 text-gray-400">Or continue with</span>
            </div>
          </div>
        </div>
        ...
        <div className="px-8 pb-8 space-y-3">
          ...
          <Button
            ...
            className="w-full border-ghost-purple/30 bg-ghost-gray/30 hover:bg-ghost-purple/20 hover:border-ghost-purple/60 text-white transition-all duration-300"
          >
