        ...
        <div className="relative w-full max-w-sm sm:max-w-md my-4 sm:my-8 mx-auto">
          <div className="relative flex flex-col bg-gradient-to-br from-ghost-dark via-ghost-gray to-ghost-dark border border-ghost-purple/30 rounded-xl sm:rounded-2xl shadow-2xl shadow-ghost-purple/20 animate-in zoom-in-95 slide-in-from-bottom-5 duration-300 max-h-[90vh] overflow-y-auto">
            ...
            {mode !== 'private' ? (
              <form onSubmit={handleSubmit} className="px-6 sm:px-8 pb-4 sm:pb-6 space-y-3 sm:space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 sm:pl-12 h-11 sm:h-12 bg-gray-800/50 border border-white/10 text-white placeholder:text-gray-400 focus:border-purple-500/50 focus:bg-gray-800/80 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm sm:text-base"
                  />
                </div>
                ...
                {/* Password */}
                <div className="relative">
                  <Lock className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 w-5 h-5 sm:w-5 sm:h-5 text-gray-400" />
                  <Input
                    type={showPassword ? 'text' : 'password'}
                    placeholder="Password"
                    value={formData.password}
                    onChange={(e) => handleInputChange('password', e.target.value)}
                    className="pl-10 sm:pl-12 pr-10 sm:pr-12 h-11 sm:h-12 bg-gray-800/50 border border-white/10 text-white placeholder:text-gray-400 focus:border-purple-500/50 focus:bg-gray-800/80 focus:outline-none focus:ring-1 focus:ring-purple-500 text-sm sm:text-base"
                  />
                  <button
                    type="button"
                ...
                <Button
                  type="submit"
                  className="w-full h-11 sm:h-12 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 shadow-lg shadow-purple-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-purple-500 text-sm sm:text-base mt-2"
                >
              ...
              <div className="px-6 sm:px-8 pb-4 sm:pb-6 space-y-4">
                {/* Generated Username */}
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Input
                      ...
                      readOnly
                      className="bg-gray-800/50 border border-white/10 text-white font-mono focus:border-purple-500/50 focus:bg-gray-800/80 focus:outline-none focus:ring-1 focus:ring-purple-500"
                    />
                    <Button
                      variant="outline"
                      size="icon"
                      onClick={copyUsername}
                      className="border-purple-500/30 bg-gray-800/50 hover:bg-purple-500/20 hover:border-purple-500/60 transform transition-transform duration-200 hover:scale-105"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="pr-10 bg-gray-800/50 border border-white/10 text-white placeholder:text-gray-400 focus:border-purple-500/50 focus:bg-gray-800/80 focus:outline-none focus:ring-1 focus:ring-purple-500"
                    />
                    <Button
                      type="button"
                      variant="ghost"
                ...
                {/* Warning Box */}
                <div className="rounded-lg border border-red-500/30 bg-red-900/20 p-4 mt-4">
                ...
                <Button
                  ...
                  className="w-full h-11 sm:h-12 bg-gradient-to-r from-purple-600 to-blue-600 text-white font-bold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 shadow-lg shadow-purple-500/30 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-purple-500 text-sm sm:text-base mt-4"
                >
            ...
            <TooltipProvider>
              <div className="px-6 sm:px-8 pb-6 sm:pb-8 flex justify-center space-x-4">
                {/* Google */}
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      className="border-purple-500/30 bg-gray-800/50 hover:bg-purple-500/20 hover:border-purple-500/60 text-white transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-purple-500 h-10 w-10"
                    >
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      ...
                      onClick={() => setMode('private')}
                      className={`border-purple-500/30 bg-gray-800/50 hover:bg-purple-500/20 hover:border-purple-500/60 text-white transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 focus:ring-purple-500 h-10 w-10 ${
                        mode === 'private' ? 'border-purple-500 bg-purple-500/30' : ''
                      }`}
                    >
            ...
            {/* Footer */}
            <div className="px-6 sm:px-8 pb-6 text-center text-xs text-gray-400">
              {mode === 'login' ? (
                <p>
