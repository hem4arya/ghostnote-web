...
export default function AuthForm({ open, onOpenChange, view: initialView = 'sign_in', onOpenPrivateAccount }: AuthFormProps) {
  ...
  return (
    <ClientDialog
      ...
      description={view === 'sign_in' ? 'Sign in to continue to Ghost-Note.' : 'Join the community and start sharing your notes.'}
      className="sm:max-w-md bg-gradient-to-br from-card to-card/90 border-primary/20 w-full max-w-screen-sm mx-auto p-6"
    >
